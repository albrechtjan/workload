...
class Lecture(models.Model):
    ...
    startDay = models.DateField()  # The day of the first lecture event.
    # Or the monday of the week when the lecture starts.
...
class Student(models.Model):
    ...
    semesterOfStudy = models.IntegerField(default=0)  # 0 means the semester has not been set. \todo: use none instead
    ignoreData = models.BooleanField(default=False)  # if True, entries we should ignore during evaluation
